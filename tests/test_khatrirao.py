...
def test_khatrirao():
    ...
    answer = np.array([[1, 8, 27], [4, 20, 54], [4, 20, 54], [16, 50, 108], [4, 20, 54], [16, 50, 108], [16, 50, 108], [64, 125, 216]])
    ...
    result = np.vstack((a_2[0, 0]*np.ones((16,1)), a_2[1, 0]*np.ones((16, 1)), a_2[2, 0]*np.ones((16, 1)),
    ...
    assert "Khatri Rao Acts on multiple Array arguments or a list of Arrays" in str(excinfo)
